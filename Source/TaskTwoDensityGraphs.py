...
#	This code reads in multiple density file
#	in text mode, and parses the water density
...
#	the files of analysis reside 

densities = os.path.join(folder,"../MassDensities/100")
filePaths = [ os.path.join(densities,name) for name in os.listdir(densities) ]
